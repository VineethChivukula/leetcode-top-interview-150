 ...
 * the array. We also need to modify the array such that the elements can be in
 * any order as they were in the original array. The remaining elements are not
